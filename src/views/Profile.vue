<template>
  ...
  <div class="content-box-group-container" v-if="$store.state.loadComplete">
    <ContentBox title="You" class="profile" selectable>
      <p>
        Username:
        <code v-text="`${$store.state.user?.username}`" />
      </p>
      <p>
        User ID:
  ...
  >
    <p>
      We're sad to see you go, but we understand if you really want to. Remember
      that this is permanent. All of your files will be permanently deleted,
      your account data will be deleted, not anonymized, and your username will
      be available to be taken by anyone creating a new account.
    </p>
    <p>
      If you're 100% positive you would like to delete your account, please
      confirm your username and password below.
    </p>
