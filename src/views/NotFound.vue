<template>
  ...
  <transition name="fade">
    <p v-if="$data.line >= 9">I guess I'll do this myself. You are useless.</p>
  </transition>
  <transition name="fade">
  ...
  <transition name="fade">
    <p v-if="$data.line >= 12"
      >No, I'm not calling mom and dad. I can get us home myself with or without
      this stupid magic button.</p
    >
  </transition>
  <transition name="fade">
    <p v-if="$data.line >= 13"
